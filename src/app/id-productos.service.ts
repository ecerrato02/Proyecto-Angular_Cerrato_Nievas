...
export class IdProductosService {
  ...
  eliminarTodasUnidadesCarrito(idProducto: number){
    const index = this.arrayCarrito.findIndex(productoCarrito => productoCarrito.idProducto === idProducto);
