...
export class IdProductosService {
  ...
  guardarProductoEnLocalStorage(producto: productos) {
    localStorage.setItem('producto_' + producto.productNameUrl, JSON.stringify(producto));
  }
